    ...
    <div class="offcanvas offcanvas-start bg-light" tabindex="-1" id="sidebarAdmin" aria-labelledby="sidebarAdminLabel">
        ...
        <div class="offcanvas-body p-0">
            <ul class="list-group list-group-flush">
                <a href="<?php echo e(route('content.admin.users')); ?>" class="list-group-item list-group-item-action">
                    <i class="bi bi-person-gear me-2"></i>Pengguna
                </a>
                <a href="<?php echo e(route('content.admin.siswa')); ?>" class="list-group-item list-group-item-action">
                    <i class="bi bi-person-lines-fill me-2"></i>Siswa
                </a>
                <a href="<?php echo e(route('content.admin.kelas')); ?>" class="list-group-item list-group-item-action">
